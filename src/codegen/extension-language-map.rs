...
::phf::Map {
    ...
    entries: &[
        ...
        (".syntax", &["YAML"]),
        (".arpa", &["DNS Zone"]),
        (".inc", &["Pascal", "Motorola 68K Assembly", "NASL", "SQL", "SourcePawn", "Pawn", "POV-Ray SDL", "PHP", "C++", "HTML", "Assembly"]),
        (".hql", &["HiveQL"]),
        (".asmx", &["ASP"]),
        (".gn", &["GN"]),
        ...
        (".pro", &["INI", "QMake", "IDL", "Proguard", "Prolog"]),
        (".nimrod", &["Nim"]),
        (".dpatch", &["Darcs Patch"]),
        (".rabl", &["Ruby"]),
        (".moo", &["Moocode", "Mercury"]),
        ...
        (".ronn", &["Markdown"]),
        (".jake", &["JavaScript"]),
        (".fcgi", &["Lua", "Python", "Shell", "PHP", "Ruby", "Perl"]),
        (".arc", &["Arc"]),
        (".udo", &["Csound"]),
        (".csl", &["XML"]),
        (".sexp", &["Common Lisp"]),
        ...
        (".m", &["Limbo", "Objective-C", "MATLAB", "MUF", "M", "Mercury", "Mathematica"]),
        (".nuspec", &["XML"]),
        (".bibtex", &["BibTeX"]),
        (".8xp.txt", &["TI Program"]),
        (".sbt", &["Scala"]),
        ...
        (".h++", &["C++"]),
        (".m4", &["M4Sugar", "M4"]),
        (".sql", &["SQL", "PLpgSQL", "PLSQL", "SQLPL", "TSQL"]),
        (".nasl", &["NASL"]),
        (".scm", &["Scheme"]),
        (".pony", &["Pony"]),
        (".scala", &["Scala"]),
